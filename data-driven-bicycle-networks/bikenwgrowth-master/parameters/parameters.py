...
plotparam_analysis = {
			"bikegrown": [{"linewidth": 1.5, "color": '#1f77b4', "linestyle": "solid", "label": "length (Szell)"},

                         {"linewidth": 1.5, "color": 'b', "linestyle": "solid", "label": "d_W {α = 1} (bike-flow)"},
                         {"linewidth": 1.5, "color": '#d62728', "linestyle": "solid", "label": "d_W {α = 0} (accessibility)"},
                         {"linewidth": 1.5, "color": '#ff7f0e', "linestyle": "solid", "label": "d_W {α = 0.5} (equal trade-off)"}],
